...
export default function AudioPlayer() {
    ...
    return (
        <Card className="@container fixed inset-x-0 bottom-0 z-50 flex w-full flex-row items-center justify-center rounded-none border-none p-0 md:border-t md:border-solid md:p-3">
            <audio ref={audioRef} />
            <div className="grid w-full auto-rows-min grid-cols-[auto] grid-rows-[auto_auto] items-center gap-2 md:flex md:grid-rows-1 md:flex-row md:items-center xl:max-w-[95%]">
                <div className="row-start-2 flex flex-row items-center justify-between px-2 pb-2 md:pb-0">
